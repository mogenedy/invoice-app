                ...
                <form id="invoice-form" method="POST" action="{{ route('invoices.update', $invoice->id) }}">
                        ...
                        @foreach ($invoice->items as $index => $item)
                            <div class="item-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="price_per_unit_{{ $index }}"
                                        name="items[{{ $index }}][price_per_unit]"
                                        value="{{ $item->price_per_unit }}" step="0.01" min="0" required>
                                </div>
                                <div class="form-group">
                                    <label for="total_{{ $index }}">Total:</label>
                                    <input type="number" class="form-control" id="total_{{ $index }}"
                                        name="items[{{ $index }}][total]" value="{{ $item->total }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="total_amount" name="total_amount"
                            value="{{ $invoice->total_amount }}" step="0.01" min="0" readonly>
                    </div>
